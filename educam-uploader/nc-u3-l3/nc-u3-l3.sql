...
Règle d''or : le reste est toujours plus petit que le diviseur (regarde le schéma).',
  ...
  (v_content, 2, 'image', NULL,
   '[[nc-u3-l3/division-elements.svg]]',
