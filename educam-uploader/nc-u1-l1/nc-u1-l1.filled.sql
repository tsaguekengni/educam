...
BEGIN
  ...
  (v_intro, 2, 'image', NULL,
   'https://brrutnxaizdllthgcnqm.supabase.co/storage/v1/object/public/lesson-images/nc-u1-l1/intro-marche.png',
  ...
  (v_content, 3, 'image', NULL,
   'https://brrutnxaizdllthgcnqm.supabase.co/storage/v1/object/public/lesson-images/nc-u1-l1/venn-langues.svg',
  ...
  (v_content, 6, 'image', NULL,
   'https://brrutnxaizdllthgcnqm.supabase.co/storage/v1/object/public/lesson-images/nc-u1-l1/grands-nombres-reveal.svg',
  ...
  (v_content, 8, 'image', NULL,
   'https://brrutnxaizdllthgcnqm.supabase.co/storage/v1/object/public/lesson-images/nc-u1-l1/tableau-numeration.svg',
  ...
  (v_content, 10, 'image', NULL,
   'https://brrutnxaizdllthgcnqm.supabase.co/storage/v1/object/public/lesson-images/nc-u1-l1/decomposition.svg',
  ...
  (v_content, 13, 'image', NULL,
   'https://brrutnxaizdllthgcnqm.supabase.co/storage/v1/object/public/lesson-images/nc-u1-l1/addition-ladder.svg',
  ...
  (v_content, 15, 'image', NULL,
   'https://brrutnxaizdllthgcnqm.supabase.co/storage/v1/object/public/lesson-images/nc-u1-l1/soustraction-ladder.svg',
  ...
  (v_content, 17, 'image', NULL,
   'https://brrutnxaizdllthgcnqm.supabase.co/storage/v1/object/public/lesson-images/nc-u1-l1/calcul-mental.svg',
  ...
  (v_activity, 3, 'image', NULL,
   'https://brrutnxaizdllthgcnqm.supabase.co/storage/v1/object/public/lesson-images/nc-u1-l1/activite-marche.png',
...
Exemple : les élèves qui parlent français et anglais se placent au milieu.',
  ...
  (v_bilan, 4, 'image', NULL,
   'https://brrutnxaizdllthgcnqm.supabase.co/storage/v1/object/public/lesson-images/nc-u1-l1/venn-cahier.svg',
...
Exemple : 18 500 + 3 750 = 22 250 ; 50 000 − 12 800 = 37 200.',
  ...
  (v_bilan, 8, 'image', NULL,
   'https://brrutnxaizdllthgcnqm.supabase.co/storage/v1/object/public/lesson-images/nc-u1-l1/operations-cahier.svg',
