...
BEGIN
  ...
  (v_intro, 4, 'image', NULL,
   'https://brrutnxaizdllthgcnqm.supabase.co/storage/v1/object/public/lesson-images/nc-u2-l2/intro-boutique.png',
  ...
  (v_content, 2, 'image', NULL,
   'https://brrutnxaizdllthgcnqm.supabase.co/storage/v1/object/public/lesson-images/nc-u2-l2/encadrement.svg',
  ...
  (v_content, 5, 'image', NULL,
   'https://brrutnxaizdllthgcnqm.supabase.co/storage/v1/object/public/lesson-images/nc-u2-l2/arrondir.svg',
  ...
  (v_content, 8, 'image', NULL,
   'https://brrutnxaizdllthgcnqm.supabase.co/storage/v1/object/public/lesson-images/nc-u2-l2/multiplication-posee.svg',
  ...
  (v_content, 9, 'image', NULL,
   'https://brrutnxaizdllthgcnqm.supabase.co/storage/v1/object/public/lesson-images/nc-u2-l2/commercant-cafe.png',
  ...
  (v_content, 12, 'image', NULL,
   'https://brrutnxaizdllthgcnqm.supabase.co/storage/v1/object/public/lesson-images/nc-u2-l2/preuve-par-9.svg',
  ...
  (v_content, 14, 'image', NULL,
   'https://brrutnxaizdllthgcnqm.supabase.co/storage/v1/object/public/lesson-images/nc-u2-l2/astuce-table-9.svg',
  ...
  (v_activity, 3, 'image', NULL,
   'https://brrutnxaizdllthgcnqm.supabase.co/storage/v1/object/public/lesson-images/nc-u2-l2/activite-tables.png',
...
Exemple : 7 800 < 7 845 < 7 900 (à la centaine près).',
  ...
  (v_bilan, 4, 'image', NULL,
   'https://brrutnxaizdllthgcnqm.supabase.co/storage/v1/object/public/lesson-images/nc-u2-l2/encadrement-cahier.svg',
...
Exemple : 7 845 ≈ 7 800 ; 7 867 ≈ 7 900.',
  ...
  (v_bilan, 6, 'image', NULL,
   'https://brrutnxaizdllthgcnqm.supabase.co/storage/v1/object/public/lesson-images/nc-u2-l2/arrondir-cahier.svg',
...
Exemple : 2 453 × 26 = 63 778.',
  ...
  (v_bilan, 8, 'image', NULL,
   'https://brrutnxaizdllthgcnqm.supabase.co/storage/v1/object/public/lesson-images/nc-u2-l2/multiplication-cahier.svg',
