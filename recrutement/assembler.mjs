// Assemble offre.html = entête de la plaquette (police Inter incluse)
//                      + feuille du protocole + additions de l'offre + corps.
// Première commande de la chaîne. offre.html est engendré, jamais édité :
// le seul fichier de contenu à modifier est _corps.html ; la mise en forme
...
writeFileSync('offre.html', html);

const n = (html.match(/<\/style>/g) || []).length;
if (n !== 1) throw new Error(`offre.html : ${n} balises </style>, attendu 1`);
console.log(`✓ offre.html — ${(html.length / 1024).toFixed(0)} Ko`);
